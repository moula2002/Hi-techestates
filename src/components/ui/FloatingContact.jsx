  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end">
      ...
      >
        ...
        <span className="absolute right-full mr-4 bg-[#25D366] text-white px-3 py-1 rounded text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
          WhatsApp Us
        </span>
      </a>
    </div>
